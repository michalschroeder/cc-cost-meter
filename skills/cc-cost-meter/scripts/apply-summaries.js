...
//     | node scripts/render-report.js --out ./session-cost-<id>.html --record-grade
// (--record-grade lives on the renderer: the grade is only worth keeping once the
//  report it describes actually exists on disk.)
//
